        ...
        <div className="flex justify-center items-center w-[calc(100%-4rem)] h-[calc(100dvh-4rem)] z-20">
          ...
          <div className="flex-1 centred flex-col h-full backgroundImage xsm:rounded-2xl md:rounded-l-[0] lg:rounded-r-[2rem] z-20">
            <div className="flex flex-col justify-center gap-2 mb-8">
              <p className="xsm:text-xs lg:text-lg">
            ...
            <div className="h-1 xsm:w-full lg:w-3/4 border-b border-primary/50 -mt-4 mb-8" />
            <RegisterForm />
            <div className="h-1 xsm:w-full lg:w-3/4 border-b border-primary/50 my-4" />
            <p className="text-center text-primary-dark xsm:text-xs lg:text-lg">
              Already have an account?{" "}
              <a
                href="/login"
                className="text-accentDark font-bold xsm:text-sm lg:text-lg hover:underline transition-all duration-300"
              >
                Sign in
              </a>
            </p>
